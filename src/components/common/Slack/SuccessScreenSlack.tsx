  ...
  return (
    ...
    <div >
        <div className='  cc-p-[32px] md:cc-p-[16px] md:cc-mt-[188px]'>
            ...
            <p className='cc-text-[26px] cc-leading-[40px] cc-font-medium cc-tracking-[-0.26px] cc-text-[#100C20] cc-mt-[24px] md:cc-mt-[16px] md:cc-text-[20px] md:cc-leading-[32px]  dark:cc-text-dark-text-white '>12 Channels have been added.</p>
