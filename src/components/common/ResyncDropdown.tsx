                    ...
                    resyncDrop.map((item)=>(
                      ...
                      >
                        <div className='cc-flex cc-justify-between cc-items-center cc-w-full'>
                          ...
                          {
                            item === 'Re-Sync Account'? <img className='cc-w-[13px] cc-h-[13px]' src={refresh} alt="" />: <img className='cc-w-[13px] cc-h-[13px] dark:cc-invert-[1] dark:cc-hue-rotate-180"' src={AddCircleIconBlack} alt="" />
                          }
  ...
  return (
    ...
    <DropdownMenu>
      <DropdownMenuTrigger asChild>
          ...
          <svg className='cc-cursor-pointer addIconsvg' xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 18 18" fill="none">
  <path fill-rule="evenodd" clip-rule="evenodd" d="M8.99995 12.4887L3.83704 7.32583L5.16286 6L8.99995 9.83709L12.837 6L14.1629 7.32583L8.99995 12.4887Z" fill="black"/>
</svg>
