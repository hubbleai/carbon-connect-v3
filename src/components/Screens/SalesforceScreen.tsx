  ...
  const fetchOauthURL = async () => {
    try {
      if (!salesforceDomain) {
        setBannerState({
          type: "ERROR",
          message: "Please enter your salesforce domain.",
        });
        return;
      }
      ...
      if (!domain.includes("my.salesforce.com")) {
        setBannerState({
          type: "ERROR",
          message: "Domain should be of format {subdomain}.my.salesforce.com",
        });
        return;
      }
    ...
    <>
      ...
      <div className="cc-p-4 cc-min-h-0 cc-flex-grow">
        ...
        <div className="cc-text-base cc-font-semibold cc-mb-5 dark:cc-text-dark-text-white">
          ...
          of the acount you wish to connect. Do not include scheme, path, or
          trailing slashes.
        </div>
        <Input
          type="text"
